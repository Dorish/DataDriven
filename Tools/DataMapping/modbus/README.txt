...
Leading and trailing spaces in the driver spreadsheet won't cause the script to crash.
Can enter relative paths to the command line for the input spreadsheet.
