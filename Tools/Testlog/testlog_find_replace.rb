...
#TODO Rename this file to something more meaningful - testlog_find_replace.rb
#TODO Add user query for Testlog folder to start the updates/changes at
#TODO Add user query for element ID to change
#TODO Add user query for element data - the update
#TODO Add option for user to get data from a file or a specific test case to copy element data from


update  = Test_log.new('C:\Documents and Settings\brownd9684\My Documents\Google Drive\Multilink\TestLog\Projects\temp\Project Test Cases')
update.update_test_case_all('notes2','<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"><html xmlns:o = "urn:schemas-microsoft-com:office:office"><head><meta content="text/html; charset=unicode" http-equiv="Content-Type"><meta name="GENERATOR" content="MSHTML 8.00.6001.19394"></head><body><div><table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-COLLAPSE: collapse; BORDER-TOP: medium none; BORDER-RIGHT: medium none; mso-border-alt: solid windowtext .5pt; mso-yfti-tbllook: 480; mso-padding-alt: 0in 5.4pt 0in 5.4pt; mso-border-insideh: .5pt solid windowtext; mso-border-insidev: .5pt solid windowtext" border=1 cellSpacing=0 cellPadding=0>  <tbody>  <tr>    <td valign="top" width="95">      <p align="center"><strong>Date<o:p></o:p></strong></td>    <td valign="top" width="197">      <p align="center"><strong>Description<o:p></o:p></strong></td>    <td>      <div align="center">&nbsp;<strong>Rev</strong>&nbsp; </div></td>    <td valign="top" width="126">      <p align="center"><strong>Name<o:p></o:p></strong></td></tr>  <tr>    <td valign="top" width="95">01/10/2012</td>    <td valign="top" width="197">Initial Document<o:p></o:p></td>    <td>      <div align="center">0</div></td>    <td valign="top" width="126">Jeff hart</td></tr>  <tr>    <td>&nbsp;</td>    <td>&lt;leave blank&gt;</td>    <td></td>    <td></td></tr></tbody></table></div></body></html>')
